...
export default function SiteFooter() {
  const socialLinks = [
    ...
    {
      name: 'YouTube',
      handle: '@NIEIEEESTUDENTBRANCH',
      url: 'https://www.youtube.com/@NIEIEEESTUDENTBRANCH',
      color: '#EF4444',
      badge: 'WATCH',
    ...
    {
      name: 'NISBits',
      handle: 'Official Playlist',
      url: 'https://youtube.com/playlist?list=PLVDx7sfjQxUE&si=GvLNr1WOR9qF9mKk',
      color: '#F43F5E',
      badge: 'PLAYLIST',
    ...
    {
      name: 'LinkedIn',
      handle: 'NISB Official',
      url: 'https://www.linkedin.com/company/nisb',
      color: '#0A66C2',
      badge: 'NETWORK',
